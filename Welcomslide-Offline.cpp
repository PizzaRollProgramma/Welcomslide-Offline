...
int output(){                                                                                                                   //HERE
    ...
    outputFile <<"}"<< endl;
    outputFile <<"body {background-color: green}"<< endl;
    ...
    outputFile <<"font-family: arial;"<< endl;
    ...
    if (stop == "Y"){
        ...
        if (month == "3"){
            ...
            if (month == "4"){
                ...
                outputFile <<"font-family: robo;"<< endl;
                outputFile <<"}"<< endl;
                outputFile <<"body {background-color: yellow}"<< endl;
                outputFile <<"#smul {"<< endl;
                outputFile <<"position: relative;"<< endl;
                outputFile <<"top: 50%;"<< endl;
                outputFile <<"left: 33%;"<< endl;
        ...
        if (month == "7"){
            ...
            outputFile <<"font-family: robo;"<< endl;
            outputFile <<"}"<< endl;
            outputFile <<"body {background-color: orange}"<< endl;
            outputFile <<"#smul {"<< endl;
            outputFile <<"position: relative;"<< endl;
            outputFile <<"top: 50%;"<< endl;
            outputFile <<"left: 33%;"<< endl;
